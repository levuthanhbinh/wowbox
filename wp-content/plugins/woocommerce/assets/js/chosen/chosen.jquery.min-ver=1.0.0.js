...
(function () {
    ...
    t = function () {
        ...
        e.prototype.result_add_option = function (e) {
            var t, n;
            if (!e.search_match)return "";
            if (!this.include_option_in_results(e))return "";
            t = [];
            ...
            for (l = 0, c = h.length; l < c; l++) {
                ...
                if (this.include_option_in_results(t)) {
                    ...
                    if (!t.group || !!this.group_search) {
                        ...
                        } else t.group_array_index != null && this.results_data[t.group_array_index].search_match && (t.search_match = !0)
                    }
                }
            }
            this.result_clear_highlight();
    ...
    n = function (t) {
        ...
        n.prototype.choice_build = function (t) {
            ...
            if (t.disabled)n.addClass("search-choice-disabled"); else {
        ...
        n.prototype.result_select = function (e) {
            ...
            if (this.result_highlight) {
                ...
                if (this.is_multiple)t.removeClass("active-result"); else {
                ...
                this.search_field.val("");
                (this.is_multiple || this.form_field.selectedIndex !== this.current_selectedIndex) && this.form_field_jq.trigger("change", {selected: this.form_field.options[n.options_index].value});
                this.current_selectedIndex = this.form_field.selectedIndex;
                return this.search_field_scale()
            }
        };
        n.prototype.single_set_selected_text = function (e) {
            ...
            if (e === this.default_text)this.selected_item.addClass("chosen-default"); else {
        ...
        n.prototype.keyup_arrow = function () {
            ...
            if (this.result_highlight) {
                ...
                if (e.length)return this.result_do_highlight(e.first());
