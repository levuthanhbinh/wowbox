...
var overlay = {
    ...
    open: function (id) {
        ...
        $.post(url, {action: 'berg_load_single_portfolio', data: {'id': id}}, function (response) {
            ...
            $('.berg-overlay-background').velocity({opacity: 1}, {
    ...
    close: function () {
        ...
        $('body').removeClass('berg-overlay-active');
        $('.berg-overlay-container').delay(100).velocity({opacity: 0}, {
            complete: function () {
                $(window).scrollTop(that.oldScroll);
                $('.berg-overlay-background').velocity({opacity: 0}, {
    ...
    open: function () {
        $('.reorder a').on(click, function (e) {
            ...
            if ($('body').hasClass('mobile-nav-show')) {
                ...
                $('.flyout-container').velocity({height: $('.flyout-container .menu > li').height() * $('.flyout-container .menu > li').length}, {
                    complete: function () {
        ...
        $('.flyout-container .menu-item .open-children').on(click, function (e) {
            ...
            if ($(this).next('.subnav-wrapper').length > 0) {
                ...
                if ($(this).next('.subnav-wrapper').hasClass('open')) {
                    ...
                    $(this).next('.subnav-wrapper').velocity({height: 0}, {
                        complete: function () {
                    ...
                    $(this).next('.subnav-wrapper').velocity({height: $(this).next('.subnav-wrapper').children('li').height() * $(this).next('.subnav-wrapper').children('li').length}, {
                        complete: function () {
...
var gallery = {
    ...
    loadMore: function () {
        ...
        $.post(url, {
            action: 'berg_load_more_portfolio',
            data: {'pageId': pageId, 'page': that.page}
        }, function (response) {
