...
(function (a) {
    a.fn.fullpage = function (c) {
        ...
        function da(b) {
            ...
            if (!P(b.target) && (b = a(".fp-section.active"), !t && !p))if (d = Q(d), w = d.y, A = d.x, b.find(".fp-slides").length && Math.abs(B - A) > Math.abs(x - w))Math.abs(B - A) >
        ...
        function n(b) {
            if (c.autoScrolling) {
                ...
                if (!t)if (d = d.find(".fp-slides").length ? d.find(".fp-slide.active").find(".fp-scrollable") : d.find(".fp-scrollable"),
                    0 > b)if (0 < d.length)if (C("bottom", d))a.fn.fullpage.moveSectionDown(); else return !0; else a.fn.fullpage.moveSectionDown(); else if (0 < d.length)if (C("top", d))a.fn.fullpage.moveSectionUp(); else return !0; else a.fn.fullpage.moveSectionUp();
                return !1
            }
        }
        ...
        function k(b, d, e) {
            ...
            if ("undefined" !== typeof g) {
                var g = g.top, y = G(b), r = b.data("anchor"), h = b.index(".fp-section"), p = b.find(".fp-slide.active"), s = a(".fp-section.active"), l = s.index(".fp-section") + 1, E = D;
                ...
                if (c.autoScrolling && c.continuousVertical && "undefined" !== typeof e && (!e && "up" == y || e && "down" == y)) {
                    ...
                    var k = s, g = b.position(), g = g.top, y = G(b)
                }
                ...
                c.css3 && c.autoScrolling ? (a.isFunction(c.onLeave) && !E && c.onLeave.call(this, l, h + 1, y), T("translate3d(0px, -" + g +
                ...
                }, c.scrollingSpeed)) : (a.isFunction(c.onLeave) && !E && c.onLeave.call(this, l, h + 1, y), a(b).animate(f, c.scrollingSpeed, c.easing, function () {
                    m();
                    a.isFunction(c.afterLoad) && !E && c.afterLoad.call(this, r, h + 1);
                    setTimeout(function () {
                        t = !1;
        ...
        function U() {
            if (!F) {
                var b = window.location.hash.replace("#",
                    "").split("/"), a = b[0], b = b[1];
                if (a.length) {
                    var c = "undefined" === typeof v, f = "undefined" === typeof v && "undefined" === typeof b && !p;
                    (a && a !== v && !c || f || !p && J != b) && K(a, b)
                }
            }
        }

        function q(b, d) {
            var e = d.position(), f = b.find(".fp-slidesContainer").parent(), g = d.index(), h = b.closest(".fp-section"), r = h.index(".fp-section"), k = h.data("anchor"), l = h.find(".fp-slidesNav"), s = d.data("anchor"), m = D;
            if (c.onSlideLeave) {
                var n = h.find(".fp-slide.active").index(), q;
                q = n == g ? "none" : n > g ? "left" : "right";
                m || a.isFunction(c.onSlideLeave) && c.onSlideLeave.call(this,
                    k, r + 1, n, q)
            }
            d.addClass("active").siblings().removeClass("active");
        ...
        function K(b, c) {
            ...
            b === v || e.hasClass("active") ? Z(e, c) : k(e, function () {
                Z(e, c)
            })
        }
        ...
        a.fn.fullpage.setAllowScrolling =
            function (b) {
                if (b) {
                    if (a.fn.fullpage.setMouseWheelScrolling(!0), L || ba)MSPointer = $(), a(document).off("touchstart " + MSPointer.down).on("touchstart " + MSPointer.down, ea), a(document).off("touchmove " + MSPointer.move).on("touchmove " + MSPointer.move, da)
                } else if (a.fn.fullpage.setMouseWheelScrolling(!1), L || ba)MSPointer = $(), a(document).off("touchstart " + MSPointer.down), a(document).off("touchmove " + MSPointer.move)
            };
        a.fn.fullpage.setKeyboardScrolling = function (a) {
            c.keyboardScrolling = a
        };
        var p = !1, L = navigator.userAgent.match(/(iPhone|iPod|iPad|Android|BlackBerry|BB10|Windows Phone|Tizen|Bada)/),
            ba = "ontouchstart"in window || 0 < navigator.msMaxTouchPoints, h = a(this), l = a(window).height(), t = !1, D = !1, v, J;
        ...
        a(".fp-section").each(function (b) {
            ...
            if (b.length) {
                ...
                !c.animateAnchor && d.length && (c.autoScrolling ? u(d.position().top) : (u(0), a("html, body").scrollTop(d.position().top)), H(b), I(b, null), a.isFunction(c.afterLoad) && c.afterLoad.call(this, b, d.index(".fp-section") +
